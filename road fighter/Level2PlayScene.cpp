...
Level2PlayScene::Level2PlayScene() : Scene(SceneManager::LEVEL2_SCENE_NAME)
{
}

Level2PlayScene::~Level2PlayScene()
{
}

void Level2PlayScene::onLoadResources()
{
	ApplicationManager::getInstance()->resumeApplication();
}

void Level2PlayScene::onLoadObjects()
{

	BG* bg = new BG("BG", 120000.0f, "bg2", 2);
...
void Level2PlayScene::onUnloadObjects()
{
	PhysicsManager::getInstance()->clearAll();
	Scene::onUnloadObjects();
}

void Level2PlayScene::onUnloadResources()
{
