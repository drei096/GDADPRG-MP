...
CarCrashScreen::CarCrashScreen(string name) : GameObject(name), ButtonListener()
{

}

CarCrashScreen::~CarCrashScreen()
{
...
void CarCrashScreen::initialize()
{
	...
	displayText->setText("Car crashed!");

}

void CarCrashScreen::onButtonClick(UIButton* button)
{
}
