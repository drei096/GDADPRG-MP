...
Level3PlayScene::Level3PlayScene() : Scene(SceneManager::LEVEL3_SCENE_NAME)
{
}

Level3PlayScene::~Level3PlayScene()
{
}

void Level3PlayScene::onLoadResources()
{
...
void Level3PlayScene::onUnloadObjects()
{
	PhysicsManager::getInstance()->clearAll();
	Scene::onUnloadObjects();
}

void Level3PlayScene::onUnloadResources()
{
